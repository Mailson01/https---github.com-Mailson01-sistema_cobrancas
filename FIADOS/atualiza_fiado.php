...
$sql = "UPDATE fiado SET valor = :valor, vencimento = :vencimento, numerovenda = :numerovenda WHERE id = :id";
...
<div class="painel">
    ...
    <p>Os dados do débito foram atualizados.</p>
